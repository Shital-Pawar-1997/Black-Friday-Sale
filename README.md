...
### Evaluation Metric
Mean Absolute Error (MAE) is to measure the error of a model in predicting quantitative data.

### Conclusion
Implanted supervised models such as Linear Regressor,Decision Tree Regressor. Out of these supervised models, based on the RMSE scores Decision Tree Regressor was the best performer with a score of 2373.
